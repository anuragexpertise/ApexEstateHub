...
ACCOUNTS = [
    (1,     "Balance Sheet Root",         "Bal",        "Balance Sheet",            None,  "Dr",  False,  "Dr", 0, 100),
    (2,     "Capital Account",            "CapAc",      "Capital Account",             1,  "Cr",  True,  "Cr", 0, 100),
    (21,    "Income Other Source",        "IncOther",   "Income other source",         2,  "Cr",  False,  "Cr", 0, 100),
    (211,   "Interest Income",            "IncInt",     "Interest Income",            21,  "Cr",  False,  "Cr", 0, 100),
    (2111,  "Bank Interest",              "IntBK",      "Bank Interest",             211,  "Cr",  False,  "Cr", 0, 100),
    (21111, "Saving Interest",            "IntSav",     "Saving Interest",          2111,  "Cr",  False,  "Cr", 0, 100),
    (2112,  "Exempt Income",              "IncExmpt",   "Exempt Income",             211,  "Cr",  False,  "Cr", 0, 100),
    (21112, "FD Interest",                "IntFD",      "FD Interest",              2111,  "Cr",  False,  "Cr", 0, 100),
    (21113, "Due Interest",               "IntDue",     "Maintenance Due Interest",  211,  "Cr",  False,  "Cr", 0, 100),
    (212,   "Selling Asset",              "SellAs",     "Selling Asset",              21,  "Cr",  False,  "Cr", 0, 100),
    ...
    (2311,  "Society Maintenance Charge", "SocM",       "Society Maintenance Charge", 23,  "Cr",  False,  "Cr", 0, 100),
    ...
    (2317,  "Society Fine",               "SocF",       "Society Fine Charge",        23,  "Cr",  False,  "Cr", 0, 100),
    (2318,  "Society Charge",             "SocC",       "Society Fees",               23,  "Cr",  False,  "Cr", 0, 100),
    (2319,  "Event Ticket",               "EventT",     "Event Ticket",               23,  "Cr",  False,  "Cr", 0, 100),
    (23191, "Holi",                       "Holi",       "Holi Celebrations",        2319,  "Cr",  False,  "Cr", 0, 100),
    (23192, "Diwali",                     "Diwali",     "Diwali Celebrations",      2319,  "Cr",  False,  "Cr", 0, 100),
    (2320,  "Lift AMC",                   "LiftAMC",    "Lift AMC",                   23,  "Dr", False,  "Dr", 0, 100),
    (2321,  "Intercom AMC",               "IntercomAMC", "Intercom AMC",              23,  "Dr", False,  "Dr", 0, 100),
    (2322,  "CCTV AMC",                   "CCTVAMC",    "CCTV AMC",                   23,  "Dr", False,  "Dr", 0, 100),
    (24,    "Duties Paid",                "DutyP",      "Duties Paid",                 2,  "Cr", False,  "Cr", 0, 100),
    (25,    "Taxes Paid",                 "TaxP",       "Taxes Paid",                  2,  "Cr", False,  "Cr", 0, 100),
    (26,    "Provisions",                 "Prov",       "Provisions",                  2,  "Cr",  False,  "Cr", 0, 100),
    ...
    (3,     "Loans & Advances Taken",     "LAT",        "Loans And Advances Taken",    1,  "Cr",  False,  "Cr", 0, 100),
    (4,     "Current Liabilities",        "CurLb",      "Current Liabilities",         1,  "Cr",  False,  "Cr", 0, 100),
    (5,     "Immovable Assets",           "ImAs",       "Immovable Assets",            1,  "Dr", False,  "Dr", 0, 100),
    (6,     "Movable Assets",             "MAs",        "Movable Assets",              1,  "Dr", False,  "Dr", 0, 100),
    (61,    "Furniture",                  "Fur",        "Furniture",                   6,  "Dr", True,  "Dr", 0,  10),
    (62,    "Investments",                "Inv",        "Investments",                 6,  "Dr", True,  "Dr", 0, 100),
    (63,    "Current Assets",             "CurAs",      "Current Assets",              6,  "Dr", False,  "Dr", 0, 100),
    (631,   "Bank Accounts",              "BkAc",       "Bank Accounts",              63,  "Dr", False,  "Dr", 0, 100),
    (6311,  "SBI A/c - Society",          "SBI",        "SBI A/c - Society",         631,  "Dr", True,  "Dr", 0, 100),
    (6312,  "ICICI A/c - Society",        "ICICI",      "ICICI A/c - Society",       631,  "Dr", True,  "Dr", 0, 100),
    (632,   "Deposits (Assets)",          "Dp",         "Deposits (Assets)",          63,  "Dr", True,  "Dr", 0, 100),
    (633,   "Cash-in-hand",               "CiH",        "Cash-in-hand",               63,  "Dr", True,  "Dr", 0, 100),
    (64,    "Instruments",                "Inst",       "Instruments",                 6,  "Dr", True,  "Dr", 0,  15),
    (65,    "Car",                        "Car",        "Car",                         6,  "Dr", True,  "Dr", 0,  15),
    (7,     "Loans & Advances Given",     "LAG",        "Loans & Advances Given",      1,  "Dr", True,  "Dr", 0, 100),
    (8,     "Sundry Debtors",             "SDr",        "Sundry Debtors",              1,  "Dr", True,  "Dr", 0, 100),
