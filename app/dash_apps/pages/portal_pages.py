    ...
    if active_tab == "dashboard":
        return html.Div([
            ...
            _kpi_row(
                ...
                _kpi("kpi_gate_logs_today",    "fa-receipt",  "#1abc9c", "Gate Logs Today"),
    ...
    if active_tab == "dashboard":
        return html.Div([
            ...
            _kpi_row(
                ...
                _kpi("kpi_events_total",     "fa-calendar-check","#8e44ad", "Upcoming Events"),
                _kpi("kpi_gate_logs_today",  "fa-receipt",  "#1abc9c", "Gate Logs"),
...
def security_portal_page(active_tab: str = "pass_evaluation") -> html.Div:
    ...
    if active_tab == "attendance":
        return html.Div([
            ...
            _kpi_row(_kpi("kpi_gate_logs_today", "fa-receipt", "#1abc9c", "Gate Logs Today"),
                     cols="1fr"),
            _drill_panel(),
        ], className="portal-page")
