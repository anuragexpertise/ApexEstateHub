    ...
    return html.Div(
        [
            ...
            _kpi_row(
                ...
                _kpi("kpi_societies_paid",   "fa-star",           "#17976e", "Paid Plan",    "active subscriptions"),
                _kpi("kpi_societies_free",   "fa-circle",         "#7d8ea3", "Free Plan"),
                _kpi("kpi_apartments_total", "fa-home",           "#1859b8", "Apartments",   "across all societies"),
                _kpi("kpi_vendors_total",    "fa-person-digging", "#b98a07", "Vendors"),
    ...
    if active_tab == "dashboard":
        return html.Div([
            ...
            _kpi_row(
                ...
                _kpi("kpi_gate_logs_today",    "fa-road-barrier",  "#1abc9c", "Gate Logs Today"),
    ...
    if active_tab == "dashboard":
        return html.Div([
            ...
            _kpi_row(
                ...
                _kpi("kpi_events_total",     "fa-calendar-check","#8e44ad", "Upcoming Events"),
                _kpi("kpi_gate_logs_today",  "fa-road-barrier",  "#1abc9c", "Gate Logs"),
...
def security_portal_page(active_tab: str = "pass_evaluation") -> html.Div:
    ...
    if active_tab == "attendance":
        return html.Div([
            ...
            _divider(),
            _sec_hdr("Gate Logs", "today's entries", "fa-road-barrier"),
            _kpi_row(_kpi("kpi_gate_logs_today", "fa-road-barrier", "#1abc9c", "Gate Logs Today"),
                     cols="1fr"),
            _drill_panel(),
        ], className="portal-page")
