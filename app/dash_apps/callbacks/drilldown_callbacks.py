...
ENTITY_META: dict = {
    "apartments": {
        ...
        "profile_actions": [
            ...
            },
            {
                "label": "Edit",
                "action_id": "edit",
                "target_card": "form_apartment_edit",
                "icon": "fa-edit",
                "color": "secondary",
            },
        ],
    ...
    "security": {
        ...
        "profile_actions": [
            ...
            },
            {
                "label": "Edit",
                "action_id": "edit",
                "target_card": "form_security_edit",
                "icon": "fa-edit",
                "color": "secondary",
            },
        ],
    ...
    "apt_charges": {
        ...
        "list_columns": [
            {"name": "Flat", "field": "flat_number", "sortable": True},
            {"name": "Rate/sqft", "field": "apt_maintenance_rate", "sortable": True},
            {"name": "Due Day", "field": "apt_due_day", "sortable": True},
            {"name": "Delay Fine", "field": "apt_delay_fine", "sortable": True},
            {"name": "Fine", "field": "apt_fine", "sortable": True},
            {"name": "Status", "field": "apt_status", "sortable": True},
        ],
        ...
        "profile_fields": [
            {"label": "Flat No", "field": "flat_number", "icon": "fa-home"},
            {
                ...
                "field": "apt_maintenance_rate",
                "icon": "fa-rupee-sign",
            },
            {"label": "Due Day", "field": "apt_due_day", "icon": "fa-calendar"},
            {"label": "Delay Fine", "field": "apt_delay_fine", "icon": "fa-rupee-sign"},
            {"label": "Fine", "field": "apt_fine", "icon": "fa-rupee-sign"},
            {"label": "Start Date", "field": "start_date", "icon": "fa-calendar"},
            {"label": "End Date", "field": "end_date", "icon": "fa-calendar"},
            {"label": "Status", "field": "apt_status", "icon": "fa-circle-dot"},
        ],
        "profile_actions": [
            {
            ...
            },
            {
                "label": "Edit",
                "action_id": "edit",
                "target_card": "form_apt_charge_edit",
                "icon": "fa-edit",
                "color": "secondary",
            },
        ],
        "form_fields": {
            "new": [
                ...
                {"id": "apt_delay_fine", "label": "Delay Fine", "type": "number"},
                {"id": "apt_fine", "label": "Fine", "type": "number"},
                {
                    "id": "apt_status",
                    "label": "Status",
                    "type": "select",
            ...
            "edit": [
                ...
                {"id": "apt_due_day", "label": "Due Day", "type": "number"},
                {"id": "apt_delay_fine", "label": "Delay Fine", "type": "number"},
                {"id": "apt_fine", "label": "Fine", "type": "number"},
                {
                    "id": "apt_status",
    ...
    "ven_charges": {
        ...
        "list_columns": [
            ...
            {"name": "1-Day", "field": "vendor_1day", "sortable": True},
            {"name": "7-Day", "field": "vendor_7day", "sortable": True},
            {"name": "1-Month", "field": "vendor_1mth", "sortable": True},
            {"name": "Fine", "field": "vendor_fine", "sortable": True},
            {"name": "Status", "field": "ven_status", "sortable": True},
        ],
        ...
        "profile_fields": [
            ...
            {"label": "1-Day Rate", "field": "vendor_1day", "icon": "fa-rupee-sign"},
            {"label": "7-Day Rate", "field": "vendor_7day", "icon": "fa-rupee-sign"},
            {"label": "1-Month Rate", "field": "vendor_1mth", "icon": "fa-rupee-sign"},
            {"label": "Fine", "field": "vendor_fine", "icon": "fa-rupee-sign"},
            {"label": "Start Date", "field": "start_date", "icon": "fa-calendar"},
            {"label": "End Date", "field": "end_date", "icon": "fa-calendar"},
            {"label": "Status", "field": "ven_status", "icon": "fa-circle-dot"},
        ],
        "profile_actions": [
            {
                "label": "Show Transactions",
            ...
            },
            {
                "label": "Edit",
                "action_id": "edit",
                "target_card": "form_ven_charge_edit",
                "icon": "fa-edit",
                "color": "secondary",
            },
        ],
        "form_fields": {
            "new": [
                ...
                {"id": "end_date", "label": "End Date", "type": "date"},
                {"id": "vendor_1day", "label": "1-Day Rate (₹)", "type": "number"},
                {"id": "vendor_7day", "label": "7-Day Rate (₹)", "type": "number"},
                {"id": "vendor_1mth", "label": "1-Month Rate (₹)", "type": "number"},
                {"id": "vendor_fine", "label": "Fine (₹)", "type": "number"},
                {
                    "id": "ven_status",
                    "label": "Status",
                    "type": "select",
    ...
    "societies": {
        ...
        "profile_fields": [
            ...
            {
                "label": "Secretary's Sign",
                "field": "secretary_sign",
                "icon": "fa-image",
                "type": "image",
                "size": "small",
            },
        ...
        "form_fields": {
            "new": [
                ...
                {"id": "phone", "label": "Phone", "type": "text"},
                {
                    ...
                    "label": "Plan",
                    "type": "select",
                    "options": ["Free", "10 Apts", "99 Apts", "999 Apts", "unlimited"],
                },
...
# Augment ENTITY_META with DB-derived columns where possible. This avoids
# manual mismatch between SQL schema and metadata used for forms/profiles.
try:
    from app.dash_apps.drilldown.entity_meta_loader import augment_entity_meta

    ENTITY_META = augment_entity_meta(ENTITY_META)
    print("✓ ENTITY_META augmented from SQL schema")
except Exception:
    # Silently continue if augmentation fails (keeps existing static meta)
    pass
