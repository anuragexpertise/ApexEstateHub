...
_KPI_PORTAL_ENTRIES: list[tuple[str, str, str, str]] = [
    ...
    # ADMIN - Enroll tab
    ("kpi_apartments_total", "admin", "enrolled", "Entities"),
    ("kpi_vendors_total", "admin", "enrolled", "Entities"),
    ("kpi_security_total", "admin", "enrolled", "Entities"),
    ("kpi_security_roster_count", "admin", "enrolled", "Security"),
    # ADMIN - Cashbook tab
    ...
    ("kpi_apt_charges_count", "admin", "settings", "Settings"),
    ...
    ("kpi_receivables_this_month", "admin", "financials", "Receivables"),
    ("kpi_payables_total", "admin", "financials", "Payables"),
    ("kpi_payables_this_month", "admin", "financials", "Payables"),
    ...
    ("kpi_societies_expiring_soon", "master", "dashboard", "Master"),
    ...
    ("kpi_security_bonus_due", "security", "payables", "Bonus"),
