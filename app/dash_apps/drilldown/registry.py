...
DRILLDOWN_MAP: dict = {
    ...
    "kpi_apartments_no_dues":      {"target": "list_apartments",  "label": "Apartments No Dues",      "filter": {"has_dues": False}},
    ...
    "kpi_receivables_total":       {"target": "list_receipts_tbl","label": "Receivables Total"},
    "kpi_payables_total":          {"target": "list_expenses_tbl","label": "Payables Total"},
    "kpi_vendor_payables_due":     {"target": "list_payments",    "label": "Vendor Payables Due"},
    "kpi_security_salaries_due":   {"target": "list_payments",    "label": "Security Salaries Due"},
    ...
    "kpi_apt_charges_count":             {"target": "list_apt_charges", "label": "Apartment Charges Rules"},
    "kpi_ven_charges_count":             {"target": "list_ven_charges", "label": "Vendor Charges Rules"},
    "kpi_sec_charges_count":             {"target": "list_sec_charges", "label": "Security Charges Rules"},
    "kpi_attendance_count":              {"target": "list_attendance",  "label": "Attendance Records"},
