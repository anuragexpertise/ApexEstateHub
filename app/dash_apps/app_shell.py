...
ROLE_CONFIG = {
    ...
    "apartment": {
        ...
        "tabs": [
            ...
            {"label": "Receipts Payable",  "href": "/dashboard/owner-receivables",       "icon": "fa-hand-holding-dollar"},
            {"label": "Receipts Paid",  "href": "/dashboard/owner-receipts",       "icon": "fa-file-invoice-dollar"},
            {"label": "Charges",   "href": "/dashboard/owner-charges",        "icon": "fa-file-invoice"},
    ...
    "vendor": {
        ...
        "tabs": [
            ...
            {"label": "Receipts Paid",  "href": "/dashboard/vendor-receipts", "icon": "fa-file-invoice-dollar"},
