...
ROLE_CONFIG = {
    'admin': {
        'color': '#ADD8E6', 'label': 'Admin Portal',
        'tabs': [
    ...
    'vendor': {
        'color': '#FFD700', 'label': 'Vendor Portal',
        'tabs': [
    ...
    'master': {
        'color': '#FF6B6B', 'label': 'Master Admin',
        'tabs': [
...
def create_sidebar(role, society_id=None):
    """Create sidebar based on user role. Always starts closed on mobile."""
    ...
    nav_links = [
        dbc.NavLink(
            [
                html.I(className=f"fas {tab['icon']} me-3",
                       style={'width': '20px'}),
                html.Span(tab['label']),
            ],
            href=tab['href'],
    ...
    sidebar = html.Div(
        [
            ...
            html.Div(
                [
                    ...
                    html.H5('ApexEstateHub',
                            style={'marginBottom': '4px', 'fontWeight': 'bold'}),
                    html.Small(config['label'],
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        ...
                        style={'padding': '6px 15px', 'textAlign': 'center'}
                    ),
                ],
        ...
        id='main-sidebar',
        className='glass-sidebar',          # mobile_callbacks will add/remove sidebar-open
        style={
            'position': 'fixed',
            'top': '0',
            'left': '0',
            'width': '250px',
            'height': '100vh',
            'background': 'linear-gradient(180deg, rgba(26,26,46,0.97) 0%, rgba(22,33,62,0.97) 100%)',
