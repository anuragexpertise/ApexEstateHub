-- ============================================================
-- EsateHub - FIXED SCHEMA (All Syntax Errors Corrected)
-- ============================================================

-- FIXES APPLIED:
-- 1. Added missing image fields to societies table
-- 2. Fixed accounts table - removed circular FK
-- 3. Fixed security_charges_fines table
-- 4. Added photo/id_proof fields to all entities
-- 5. Fixed gin/gist indexes syntax
...
-- ════════════════════════════════════════════════════════════════
-- ACCOUNTS TABLE - WITHOUT CIRCULAR FK
-- ════════════════════════════════════════════════════════════════
